    ...
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Resources = new()
        {
            ["zh-CN"] = new Dictionary<string, string>
            {
                ...
                ["SourceTabs.Mode"] = "独立任务模式：{0} 个文件，每个标签保存自己的处理参数。",
                ["SourceTabs.Preview"] = "独立任务共 {0} 个；当前预览：{1}",
                ["SourceTabs.Pending"] = "待处理",
                ["SourceTabs.Processing"] = "处理中",
                ["SourceTabs.Completed"] = "已完成",
                ["SourceTabs.Failed"] = "失败",
                ["SourceTabs.Remove"] = "关闭此任务",
                ["SourceTabs.ApplyToAll"] = "应用当前设置到全部",
                ["SourceTabs.AppliedToAll"] = "已将当前设置应用到另外 {0} 个任务。",
                ["Queue.ProcessCurrent"] = "仅处理当前",
                ["Queue.ProcessAll"] = "处理全部（{0}）",
                ["Queue.Cancel"] = "取消处理",
                ["Queue.Cancelling"] = "正在取消当前任务…",
                ["Queue.Cancelled"] = "已取消",
                ["Queue.RetryFailed"] = "重试失败任务",
                ["Queue.Progress"] = "{0}/{1} · {2}",
                ["Queue.Summary"] = "处理结束：成功 {0}，失败 {1}，取消 {2}",
                ["Queue.CompletedWithErrors"] = "处理完成，但有任务失败",
                ["Queue.RemainingNotProcessed"] = "其余任务尚未处理，可再次点击处理全部。",
                ["Batch.IncludeSubfolders"] = "包含子文件夹",
                ["Batch.SelectAll"] = "全部选择",
                ["Batch.SelectNone"] = "全部排除",
                ["Batch.Included"] = "已选择 {0}/{1} 个文件，所有选中文件使用统一参数。",
                ["OutputConflict.Title"] = "输出文件冲突",
                ["OutputConflict.Message"] = "发现 {0} 个已存在或同名的输出文件。请选择处理方式。",
                ["OutputConflict.AutoRename"] = "自动改名（推荐）",
                ["OutputConflict.Overwrite"] = "覆盖已有文件",
            ...
            ["en-US"] = new Dictionary<string, string>
            {
                ...
                ["SourceTabs.Mode"] = "Independent tasks: {0} files, with settings saved separately in each tab.",
                ["SourceTabs.Preview"] = "{0} independent tasks; current preview: {1}",
                ["SourceTabs.Pending"] = "Pending",
                ["SourceTabs.Processing"] = "Processing",
                ["SourceTabs.Completed"] = "Completed",
                ["SourceTabs.Failed"] = "Failed",
                ["SourceTabs.Remove"] = "Close this task",
                ["SourceTabs.ApplyToAll"] = "Apply current settings to all",
                ["SourceTabs.AppliedToAll"] = "Applied the current settings to {0} other tasks.",
                ["Queue.ProcessCurrent"] = "Process Current",
                ["Queue.ProcessAll"] = "Process All ({0})",
                ["Queue.Cancel"] = "Cancel",
                ["Queue.Cancelling"] = "Cancelling the current task…",
                ["Queue.Cancelled"] = "Cancelled",
                ["Queue.RetryFailed"] = "Retry Failed",
                ["Queue.Progress"] = "{0}/{1} · {2}",
                ["Queue.Summary"] = "Finished: {0} succeeded, {1} failed, {2} cancelled",
                ["Queue.CompletedWithErrors"] = "Completed with errors",
                ["Queue.RemainingNotProcessed"] = "Remaining tasks were not processed. You can run Process All again.",
                ["Batch.IncludeSubfolders"] = "Include subfolders",
                ["Batch.SelectAll"] = "Select all",
                ["Batch.SelectNone"] = "Exclude all",
                ["Batch.Included"] = "Selected {0} of {1} files. All selected files share the same settings.",
                ["OutputConflict.Title"] = "Output file conflicts",
                ["OutputConflict.Message"] = "Found {0} existing or duplicate output files. Choose how to continue.",
                ["OutputConflict.AutoRename"] = "Auto rename (recommended)",
                ["OutputConflict.Overwrite"] = "Overwrite existing",
